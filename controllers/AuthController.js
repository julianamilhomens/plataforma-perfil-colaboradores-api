...
var AuthController = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (error_1 instanceof zod_1.z.ZodError) {
                            next(new errorHandler_1.CustomError("Dados inv\u00E1lidos: ".concat(error_1.issues.map(function (e) { return e.message; }).join(', ')), // 👈 corrigido
                            400));
                        }
                        else {
                            next(error_1);
    ...
    AuthController.prototype.validateToken = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                try {
